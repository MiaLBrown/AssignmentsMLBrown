...
public class DisplayCustomerActivity extends AppCompatActivity {
    protected static final String url = "http://10.1.120.43:5000/update";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        addButton.setOnClickListener(v -> {
            ...
            try {
                ...
                new JSONArray(commentList);
                job.put("comments", commentList);
            ...
            JsonRequest<JSONObject> jsonRequest =
                    new JsonObjectRequest(Request.Method.POST,
                        ...
                        public Response<JSONObject> parseNetworkResponse(NetworkResponse response) {
                            Response<JSONObject> res = Response.success(finalJob, null);
